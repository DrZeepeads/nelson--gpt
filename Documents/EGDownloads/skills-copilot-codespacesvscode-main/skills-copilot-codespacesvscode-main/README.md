...
# Skills Copilot Extension

## Overview
This is a simple VS Code extension that demonstrates basic extension functionality. It provides a command to calculate numbers interactively.

## Features
- Interactive number calculation
- Shows result in an information message

## Usage
1. Open the Command Palette (Ctrl+Shift+P or Cmd+Shift+P)
2. Type "Calculate Numbers"
3. Follow the prompts to enter two numbers
4. See the calculation result in a message
