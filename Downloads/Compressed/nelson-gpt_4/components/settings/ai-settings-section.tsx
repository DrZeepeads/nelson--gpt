  ...
  return (
    <section className="space-y-4">
        ...
        {Object.entries(apiKeys).map(([key, value]) => (
          <div key={key} className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                {showKeys[key as keyof typeof showKeys] ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
              </Button>
            </div>
          </div>
        ))}
      ...
      <div className="space-y-2">
        ...
        <Select value={defaultModel} onValueChange={(value: AIModel) => updateSettings({ defaultModel: value })}>
