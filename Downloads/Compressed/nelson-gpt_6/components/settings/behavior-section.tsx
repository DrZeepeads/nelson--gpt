...
export function BehaviorSection() {
  const { language, soundNotifications, autoScroll, enterToSend, pushNotifications, updateSettings } = useSettings()
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Select value={language} onValueChange={(value: Language) => updateSettings({ language: value })}>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="pushNotifications" checked={pushNotifications} onCheckedChange={handlePushNotificationChange} />
        </div>
